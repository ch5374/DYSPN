...
import utility
from model import custom_get as get_model
from data import get as get_data
from loss import custom_get as get_loss
from summary import custom_get as get_summary
from metric import custom_get as get_metric
...
def train(gpu, args):
    ...
    for epoch in range(1, args.epochs+1):
        ...
        test(args, net, epoch, loader_test)
...
def test(args, net, epoch, loader_test):
