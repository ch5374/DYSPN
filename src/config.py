...
parser.add_argument('--split_json',
                    ...
                    #default='../data_json/nyu_train_val.json',
...
parser.add_argument('--train_val_only',
                    default=False,
                    help='merge validation with train(train, test)')
...
parser.add_argument('--decay',
                    type=str,
                    #default='10,15,20',
                    #default='10,15,25,30,40',
                    default='5,10,15,20,25,30,35,40',
                    help='learning rate decay schedule')
parser.add_argument('--gamma',
                    type=str,
                    #default='1.0,0.2,0.04',
                    #default='1.0,0.5,0.1,0.01,0.001',
                    default='1.0,0.5,0.25,0.125,0.0625,0.03125,0.015625,0.0078125',
